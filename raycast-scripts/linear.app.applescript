...
# @raycast.title Linear.app
# @raycast.mode silent

# Optional parameters:
# @raycast.icon images/linear-logo.png

# Documentation:
# @raycast.description Open linear.app in Safari
# @raycast.author Johan West
# @raycast.authorURL johanwest.com

set theUrl to "https://linear.app"
set theUrlPattern to "linear.app"
