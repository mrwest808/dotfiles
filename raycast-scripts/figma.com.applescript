...
# @raycast.title Figma.com
# @raycast.mode silent

# Optional parameters:
# @raycast.icon images/figma-logo-transparent.png

# Documentation:
# @raycast.description Open figma.com in Safari
# @raycast.author Johan West
# @raycast.authorURL johanwest.com

set theUrl to "https://www.figma.com"
set theUrlPattern to "figma.com"
